...
\small
\begin{multicols*}{5}
\input{subfiles/variations}
\input{subfiles/asymptotic-notations}
\input{subfiles/modular-arithmetic}
\input{subfiles/inclusion-exclusion}
\input{subfiles/recurrence-relations}
\end{multicols*}
\end{document}